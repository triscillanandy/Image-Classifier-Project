...
parser.add_argument('--data_dir', action='store', default='/content/drive/MyDrive/aipnd-project/flowers', dest='data_dir', type=str,
...
parser.add_argument('--checkpoint', action='store', default='/content/drive/MyDrive/aipnd-project/checkpoints/checkpoint.pth', dest='checkpoint', type=str)
...
print("Argument 1:", args.data_dir)
...
train_dir = '/content/drive/MyDrive/aipnd-project/flowers/train'
valid_dir = '/content/drive/MyDrive/aipnd-project/flowers/valid'
test_dir = '/content/drive/MyDrive/aipnd-project/flowers/test'
